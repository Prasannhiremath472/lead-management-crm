...
import ProductItemRow from '@/modules/ErpPanelModule/ProductItemRow';
...
function LoadOrderForm({ subTotal = 0, current = null }) {
  ...
  const { last_order_number = 0 } = useSelector(selectFinanceSettings) || {};
  const [lastNumber, setLastNumber] = useState(() => last_order_number + 1);
